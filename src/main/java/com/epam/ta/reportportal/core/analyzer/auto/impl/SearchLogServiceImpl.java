...
public class SearchLogServiceImpl implements SearchLogService {
	...
	private Optional<SearchRq> composeRequest(SearchLogRq request, Project project, TestItem item, Launch launch) {
		...
		List<String> logMessages = logRepository.findMessagesByLaunchIdAndItemIdAndPathAndLevelGte(item.getLaunchId(), item.getItemId(), item.getPath(), LogLevel.ERROR_INT);
