...
public final class IssueRegexConstant {
	...
	public static final String MINOR_DEFECT_ISSUE_REGEX = "^statistics\\$defects\\$minor_defect\\$((?!total$).)+.*$";
	public static final String SYSTEM_ISSUE_REGEX = "^statistics\\$defects\\$system_issue\\$((?!total$).)+.*$";
	public static final String TEST_BUG_ISSUE_REGEX = "^statistics\\$defects\\$test_bug\\$((?!total$).)+.*$";
